...
class TrainerSessionActiveExport implements FromView
{
    public function view(): View
    {
        ...
        $trainerSessions = DB::table('trainer_sessions as a')
            ...
            ->addSelect(
                ...
                DB::raw('pt_freeze_summary.latest_freeze_end as expired_leave_days'),

                DB::raw('CASE WHEN COALESCE(pt_freeze_summary.is_currently_frozen, 0) = 1 THEN "Freeze" ELSE "No Leave Days" END as leave_day_status'),
        ...
        return view('admin.trainer-session.excel', [
